...
- [`random_ellipses()`](https://castanedam.github.io/nicheR/reference/random_ellipses.md)
  ...
  reference ellipse
- [`ranges_from_data()`](https://castanedam.github.io/nicheR/reference/range_utilities.md)
  [`ranges_from_stats()`](https://castanedam.github.io/nicheR/reference/range_utilities.md)
  : Compute variable ranges from data or statistics with optional
  expansion
- [`read_nicheR()`](https://castanedam.github.io/nicheR/reference/read_nicheR.md)
  : Read a nicheR object from disk
- [`ref_ellipse`](https://castanedam.github.io/nicheR/reference/ref_ellipse.md)
