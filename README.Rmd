...
4. **Sample occurrences** — draw virtual occurrence records using various strategies
...
> [Sampling bias data](https://castanedam.github.io/nicheR/articles/sampling_bias_data.html) vignette.
...
> [Sampling occurrence data](https://castanedam.github.io/nicheR/articles/sampling_occurrence_data.html) vignette.
...
- **NicheA** — a Java-based software that pioneered environmental-space
  niche visualization and explicitly linked niche theory with simulation.
  An important conceptual foundation for nicheR.
- **[virtualspecies](https://github.com/Farewe/virtualspecies)** — a
  widely adopted R package (200+ citations) for simulating virtual species
  and benchmarking SDMs and ENMs within R.
...
well-documented R package. A Shiny GUI for interactive niche exploration
