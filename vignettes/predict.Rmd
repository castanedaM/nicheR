...
temp_ellipse <- file.path("data/", "ref_ellipse.rds")
...
temp_df   <- file.path("inst/extdata/", "predictions_df.csv")
temp_rast <- file.path("inst/extdata/", "predictions_rast.tif")

temp_3d_df   <- file.path("inst/extdata/", "predictions_3d_df.csv")
temp_3d_rast <- file.path("inst/extdata/", "predictions_3d_rast.tif")
