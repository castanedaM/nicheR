...
1.  **Pure Virtual Data:** Simulating species entirely within
    Environmental Space (E-Space), bypassing geographic rasters to test
...
3.  **Biased Occurrence Data:** Introducing real-world collection bias
    (e.g., proximity to roads) to see how human sampling effort distorts
    our view of a species’ niche.
